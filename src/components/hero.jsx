...
const Hero = () => {
  ...
  return (
    ...
    {/* Left: Text Section */}
    <div className="flex-1 text-center md:text-left animate-fade-in-left animation-delay-500">
  ...
  <span className="text-orange-500 hover:text-orange-700 transition duration-300 cursor-pointer">
    Dream PC
        ...
        {/* Right PC Image */}
        <div className='flex-1 mb-10 md:mb-0 animate-fade-in-right animation-delay-500'>
